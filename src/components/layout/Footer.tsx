...
export default function Footer() {
  return (
    ...
    >
      <div className="container mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-4 text-indigo-200">
        <div>
        ...
        <div className="text-sm text-indigo-200 text-right md:text-left">
