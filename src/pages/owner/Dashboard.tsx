    ...
    <div className="min-h-screen p-4 text-white">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            className="bg-indigo-700 text-white px-3 py-2 rounded shadow-sm"
            to="/owner/add-room"
          >
            Add room
          </Link>
          ...
          <button
            ...
            className="bg-indigo-200 text-sm px-3 py-2 rounded"
          >
            Populate images
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {rooms.map((r) => (
          <div
            key={r.id}
            className="bg-indigo-800 p-4 rounded-md shadow flex items-center gap-4 text-white"
          >
            {r.images && r.images[0] ? (
              <img
                src={r.images[0]}
              ...
              <div className="w-28 h-20 bg-indigo-900 rounded" />
            )}

            <div className="flex-1">
              <h3 className="font-semibold">{r.title}</h3>
              <p className="text-sm text-indigo-200">{r.location}</p>
            </div>
