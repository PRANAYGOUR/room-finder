...
export default function OwnerRegister() {
  ...
  return (
    <div className="max-w-md mx-auto bg-[#071028] p-6 rounded-md shadow">
      ...
      {message && <div className="text-indigo-200 mb-2">{message}</div>}
      ...
      <div className="text-sm text-indigo-200 mt-4">Already have an owner account? <Link to="/owner/login" className="text-white">Owner Login</Link></div>
    </div>
  ) 
}
